...
\begin{minipage}{.5\linewidth}
  \begin{pygmented}[lang=d,gobble=4]
    ulong fact(ulong n)
    {
      if(n < 2)
        return 1;
...
% \begin{Example}
% \begin{pygmented}[lang=lisp,tabsize=5]
...
\begin{Example}
\begin{pygmented}[lang=scheme,linenos,linenostart=1001,linenostep=2,linenosep=1cm]
...
\global\mdfdefinestyle{separateheader}{%
  frametitle={%
    ...
    {\strut Saying \emph{hello} in Eiffel};},
