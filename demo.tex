...
\setpygmented{lang=scheme,colback=shadecolor,style=emacs}
...
\section{A fancy example using \texttt{tcolorbox}}
...
\begin{pygmented}[boxing method=tcolorbox,%lang=sml,%
